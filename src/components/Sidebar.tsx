            ...
            <div className="space-y-3 text-xs">
              <div>
                ...
                {getNextLevelInfo() && (
                  <div className="text-muted-foreground mt-2">
                    {getNextLevelInfo()?.remaining} more to{" "}
                    {getNextLevelInfo()?.nextLevel}
                  </div>
                )}
                {sessionData.skillLevel === "advanced" && (
                  <div className="text-accent mt-2 font-semibold">
                    🏆 Max Level!
                  </div>
                )}
              </div>
              ...
              <div>
                ...
                <div className="text-foreground font-semibold mt-1">
                  {userPreferences?.total_explanations ||
                    sessionData.totalExplanations}
                </div>
              </div>
